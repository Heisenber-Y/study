...
T1.REPORTORNAME USERNAME,--"查勘员名称"
T1.REPORTORIDENTIFYTYPE IDENTIFYTYPE,--身份证类型
T1.REPORTORIDENTIFYNO IDENTIFYNUMBER,--"查勘员身份证号",
T1.REPORTORPHONENUMBER TEL,--"查勘员电话" ,   
'REPORTER' KIND --查勘员种类
,T1.ETL_DATE 
,"太财" COMPANY
 ,T2.COMPANYCODE	--机构代码
...
SELECT 
 CONCAT('P','00000000',nvl(USERNAME,'未知'),nvl(IDENTIFYTYPE,'未知'),nvl(IDENTIFYNUMBER,'未知')) PERSONID,
 POLICYNO,
 USERNAME,
 IDENTIFYTYPE,
 IDENTIFYNUMBER,
